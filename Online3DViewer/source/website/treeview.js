...
export class TreeViewSingleItem extends TreeViewItem
{
    constructor (name, icon)
    {
        super (name, icon);
        this.selected = false;
        this.inMultiSelection = false;
    }

    // Mark item as part of multi-selection
    SetMultiSelected (selected)
    {
        this.inMultiSelection = selected;
        console.log('Setting multi-selected state:', selected, 'for item:', this.name);
        
        if (selected) {
            this.mainElement.classList.add('multi_selected');
            this.mainElement.style.border = '2px solid var(--ov_primary_color)';
            
            // Make sure parent nodes are expanded to show this item
            ...
            this.mainElement.classList.remove('multi_selected');
    ...
    {
        console.log('Setting selected state:', selected, 'for item:', this.name);
        ...
        if (this.selected) {
            ...
            // If this item is part of multi-selection, keep the multi-selection styling

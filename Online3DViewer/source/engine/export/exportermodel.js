...
export class ExporterSettings
{
    constructor (settings)
    {
        ...
        // Options for exporting physical groups
        this.exportPhysicalGroups = false; // Whether to export each physical group as a separate file
        this.exportRemainder = true; // Whether to export meshes not in any physical group
        this.selectedGroups = null; // Array of physical group indices to export, null means all groups
